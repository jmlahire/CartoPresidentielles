import '../../../style/modules/html/navButtons.scss';

import * as d3Selection from 'd3-selection';
import * as d3Array from 'd3-array';
import * as d3Dispatch from 'd3-dispatch';
import {Component} from "./component";
import {InterTitle} from "./content.text";
...
class NavButtons extends Component{
    ...
    constructor(id, options={ }){
        super(id);
        this.options = { ...NavButtons.defaultOptions, ...options };
        this.dispatch=d3.dispatch('select');
        this.container=d3.create('nav')
            .attr('id',this.id)
            .classed(NavButtons.type,true)
