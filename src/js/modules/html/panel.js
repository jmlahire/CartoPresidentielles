import '../../../style/modules/html/panel.scss'
...
class Panel extends Component{
    ...
    constructor(id, options){
        super(id);
        this.options = {...Panel.defaultOptions,...options};
        this.state.position = this.options.initialPosition;
        this.dispatch = d3.dispatch('position');
        this.timer=new d3.timeout( () => {}, 0);
        //Creation des divs
        this._outerContainer = d3.create('div').classed(Panel.type,true).classed('right',true);
